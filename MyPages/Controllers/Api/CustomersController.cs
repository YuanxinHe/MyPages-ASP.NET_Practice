...
namespace MyPages.Controllers.Api
{
    public class CustomersController : ApiController
    {
        ...
        // POST /api/customers
        // use for creating customers.
        // insted of returning CustomerDto, we could use IHttpActionResult.
        // which contains bunch of helper method and is similar to ActionResult in MVC framework.
        [HttpPost]
        public IHttpActionResult CreateCustomer(CustomerDto customerDto)
        {
            ...
            // if customer successfully created, it will return something like this:
            // '/api/customers/10'
            // the second argument of this method, we should pass the actual object just created.
            return Created(new Uri(Request.RequestUri +"/"+ customer.Id), customerDto);
        }

        // PUT /api/customers/1
        // use for editing customers.
        [HttpPut]
